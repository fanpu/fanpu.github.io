...
description: The final part of cracking CMU's Bomblab with Angr, where
...
{% highlight python linenos %}
{% raw %} # Create a simulation manager initialized with the starting state
...
WARNING | 2020-08-04 00:07:02,736 | angr.state*plugins.symbolic_memory | The program is accessing memory or registers with an unspecified value. This could indicate unwanted behavior.
...
WARNING | 2020-08-04 00:07:02,736 | angr.state_plugins.symbolic_memory | 2) adding the state option ZERO_FILL_UNCONSTRAINED*{MEMORY,REGISTERS}, to make unknown regions hold null
WARNING | 2020-08-04 00:07:02,737 | angr.state*plugins.symbolic_memory | 3) adding the state option SYMBOL_FILL_UNCONSTRAINED*{MEMORY_REGISTERS}, to suppress these messages.
